...
public class v0_1_X_Changes {
    ...
    public static void add_v0_1_5_Changes(ArrayList<ChangeInfo> changeInfos) {
        ...
        changes.addButton(new ChangeButton(new Image(Assets.Sprites.FAUST, 6, 7, 16, 16), "리유니온 버프",
                "- _살카즈 랜서_ : 최대 체력이 _90_으로 상승했습니다.\n기본 공격력이 _20-30_으로 상승했습니다.\n가속 공격력이 _30-30(+)_로 상승했습니다. " +
                        "방어력이 _0-5(가속+)_로 변경되었습니다." + "\n\n" +
                        "- _아츠마스터 A2_ : 빔 공격의 피해량이 _35-55_로 상승했습니다.\n방어력이 _0-12_로 상승했습니다.\n회피율이 _25_로 상승했습니다." + "\n\n" +
                        "- _살카즈 스나이퍼_ : 공격력이 _30-44_로 상승했으며, 명중률이 _39_로 상승했습니다."));

        changes.addButton(new ChangeButton(new Image(Assets.Sprites.TALRU_FIGHT, 6, 32, 16, 16), "탈룰라 강화",
                "- _우르수스 감시관_ 의 체력이 20에서 _25_로 상승했습니다." + "\n\n" +
                        "- _탈룰라의 환영_들의 체력이 _330_으로, 공격력이 _22-36_으로 상승했습니다." + "\n\n" +
