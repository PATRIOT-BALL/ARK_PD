...
public class v0_3_X_Changes {
	...
	public static void add_v0_3_5_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new Image(Assets.Sprites.BLAZE, 0, 15, 12, 15), "Warrior Rework!",
				"Warrior Rework:\n" +
		...
		changes.addButton( new ChangeButton(new Image(Assets.Sprites.BLAZE, 0, 90, 12, 15), "Warrior Subclass Rework!",
				"Berserker Rework:\n" +
	...
	public static void add_v0_3_0_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new Image(Assets.Sprites.AMIYA, 0, 15, 12, 15), "Mage Rework!",
