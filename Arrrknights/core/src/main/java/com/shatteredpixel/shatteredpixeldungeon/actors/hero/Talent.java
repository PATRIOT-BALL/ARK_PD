...
public enum Talent {
	...
	//RoseCat T2
	FASTMEAL(117), RECOVERY_UPGRADE(69), DELICIOUS_FOOD(0), LOVEMEAT(118), POWERGEAR(119),
	//RoseCat T3
	AIMTRAINING(120,3), CUTLET(0,3),
	//RoseCat De_T3
	FOCUSED_ATTACK(121,3), PHYSICAL_ATTACK(122,3), BATTLEFLOW(80,3),
	//RoseCat Gu_T3
	BARRIER_OPERATION(3,3), BARRIER_REPAIR(3,3), RHODES_CAT(122,3),
	//RossCat T4
	RHODES_WEAPON(123, 3), RECALL_MEMORY(37,3),
	//RoseCat De_T4
	ESTHESIA(14, 3),
	//RoseCat Gu_T4
	SPEED_COMABT(80,3);
