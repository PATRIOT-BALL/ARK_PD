...
public class WndInfoSubclass extends WndTitledMessage {
	...
	public WndInfoSubclass(HeroClass cls, HeroSubClass subCls){
		...
		TalentsPane.TalentTierPane talentPane2 = new TalentsPane.TalentTierPane(talentList.get(3), 4, false);
		talentPane2.title.text( Messages.titleCase(Messages.get(WndHeroInfo.class, "talents2")));
		talentPane2.setRect(0, talentPane.bottom() + 5, width, talentPane.height());
		add(talentPane2);
		resize(width, (int) talentPane2.bottom());
